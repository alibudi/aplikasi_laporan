    ...
    <div class="col-md-12">
      <div class="box box-info">
		...
		<?php
                ...
                echo form_open_multipart('admin/editBeban/'.$beban->id,$name);
            ?>
	
				     <div class="form-group">
                 <label for="kategori" class="col-sm-3 control-label">Pengguna</label>
                    <div class="col-sm-9">
				             <input name="penggunaan" class="form-control" value="<?php echo $beban->penggunaan?>" placeholder="Nama">
                    </div>
				      </div>
                 <div class="form-group">
                <label for="kategori" class="col-sm-3 control-label">Saldo</label>
                <div class="col-sm-9">
                  <input type="text" id="nilai" name="saldo" value="<?php echo $beban->saldo?>"  class="form-control" placeholder="Nilai">
                  <?php echo form_error('saldo');?>
                </div>
              </div>
    <div class="form-group">
                <label for="kategori" class="col-sm-3 control-label">Total</label>
                <div class="col-sm-9">
                  <input type="text" id="nilai" name="total" value="<?php echo $beban->total?>"  class="form-control" placeholder="Nilai">
                  <?php echo form_error('saldo');?>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" id="nilai" name="harga" value="<?php echo $beban->harga?>"  class="form-control" placeholder="Nilai">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                <textarea id="editor1" name="keterangan" rows="8" cols="50"><?php echo $beban->keterangan?> </textarea>
