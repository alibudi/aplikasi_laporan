    ...
    <div class="col-md-12">
      <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <a href="<?php echo base_url('admin/memberadd');?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Akun</a><br /><br />
                    ...
                    <tr>
                         <td><?php echo $no++ ?></td>
                          ...
                          <td style="text-align: center;">
                            <a class='btn btn-info btn-xs' href="<?php echo base_url('admin/changeProfil/'.$u->id); ?>" class=""><i class="glyphicon glyphicon-edit "></i> </a> &nbsp;&nbsp;
